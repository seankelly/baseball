...
impl Sql for GameLog {
    ...
    fn read_row(row: &Row) -> Result<Self, rusqlite::Error> {
        Ok(Self {
            game_id: row.get(0)?,
            date: row.get(0)?,
            number_of_game: row.get(0)?,
            day_of_week: row.get(0)?,
            visitor_team: row.get(0)?,
            visitor_league: row.get(0)?,
            visitor_team_game_number: row.get(0)?,
            home_team: row.get(0)?,
            home_league: row.get(0)?,
            home_team_game_number: row.get(0)?,
            visitor_score: row.get(0)?,
            home_score: row.get(0)?,
            number_of_outs: row.get(0)?,
            day_night: row.get(0)?,
            completion_info: row.get(0)?,
            forfeit_info: row.get(0)?,
            protest_info: row.get(0)?,
            park_id: row.get(0)?,
            attendance: row.get(0)?,
            time_of_game: row.get(0)?,
            visitor_line_score: row.get(0)?,
            home_line_score: row.get(0)?,
            visitor_ab: row.get(0)?,
            visitor_hits: row.get(0)?,
            visitor_doubles: row.get(0)?,
            visitor_triples: row.get(0)?,
            visitor_homeruns: row.get(0)?,
            visitor_rbi: row.get(0)?,
            visitor_sac_hits: row.get(0)?,
            visitor_sac_flies: row.get(0)?,
            visitor_hbp: row.get(0)?,
            visitor_walks: row.get(0)?,
            visitor_intentional_walks: row.get(0)?,
            visitor_strikeouts: row.get(0)?,
            visitor_stolen_bases: row.get(0)?,
            visitor_caught_stealing: row.get(0)?,
            visitor_gidp: row.get(0)?,
            visitor_catcher_interference: row.get(0)?,
            visitor_left_on_base: row.get(0)?,
            visitor_pitchers_used: row.get(0)?,
            visitor_individual_earned_runs: row.get(0)?,
            visitor_team_earned_runs: row.get(0)?,
            visitor_wild_pitches: row.get(0)?,
            visitor_balks: row.get(0)?,
            visitor_putouts: row.get(0)?,
            visitor_assists: row.get(0)?,
            visitor_errors: row.get(0)?,
            visitor_passed_balls: row.get(0)?,
            visitor_double_plays: row.get(0)?,
            visitor_triple_plays: row.get(0)?,
            home_ab: row.get(0)?,
            home_hits: row.get(0)?,
            home_doubles: row.get(0)?,
            home_triples: row.get(0)?,
            home_homeruns: row.get(0)?,
            home_rbi: row.get(0)?,
            home_sac_hits: row.get(0)?,
            home_sac_flies: row.get(0)?,
            home_hbp: row.get(0)?,
            home_walks: row.get(0)?,
            home_intentional_walks: row.get(0)?,
            home_strikeouts: row.get(0)?,
            home_stolen_bases: row.get(0)?,
            home_caught_stealing: row.get(0)?,
            home_gidp: row.get(0)?,
            home_catcher_interference: row.get(0)?,
            home_left_on_base: row.get(0)?,
            home_pitchers_used: row.get(0)?,
            home_individual_earned_runs: row.get(0)?,
            home_team_earned_runs: row.get(0)?,
            home_wild_pitches: row.get(0)?,
            home_balks: row.get(0)?,
            home_putouts: row.get(0)?,
            home_assists: row.get(0)?,
            home_errors: row.get(0)?,
            home_passed_balls: row.get(0)?,
            home_double_plays: row.get(0)?,
            home_triple_plays: row.get(0)?,
            home_plate_umpire_name: row.get(0)?,
            home_plate_umpire_id: row.get(0)?,
            first_base_umpire_name: row.get(0)?,
            first_base_umpire_id: row.get(0)?,
            second_base_umpire_name: row.get(0)?,
            second_base_umpire_id: row.get(0)?,
            third_base_umpire_name: row.get(0)?,
            third_base_umpire_id: row.get(0)?,
            left_field_umpire_name: row.get(0)?,
            left_field_umpire_id: row.get(0)?,
            right_field_umpire_name: row.get(0)?,
            right_field_umpire_id: row.get(0)?,
            visitor_manager_id: row.get(0)?,
            visitor_manager_name: row.get(0)?,
            home_manager_id: row.get(0)?,
            home_manager_name: row.get(0)?,
            winning_pitcher_name: row.get(0)?,
            winning_pitcher_id: row.get(0)?,
            losing_pitcher_name: row.get(0)?,
            losing_pitcher_id: row.get(0)?,
            saving_pitcher_name: row.get(0)?,
            saving_pitcher_id: row.get(0)?,
            gwrbi_player_name: row.get(0)?,
            gwrbi_player_id: row.get(0)?,
            visitor_starter_name: row.get(0)?,
            visitor_starter_id: row.get(0)?,
            home_starter_name: row.get(0)?,
            home_starter_id: row.get(0)?,
            visitor_1_id: row.get(0)?,
            visitor_1_name: row.get(0)?,
            visitor_1_pos: row.get(0)?,
            visitor_2_id: row.get(0)?,
            visitor_2_name: row.get(0)?,
            visitor_2_pos: row.get(0)?,
            visitor_3_id: row.get(0)?,
            visitor_3_name: row.get(0)?,
            visitor_3_pos: row.get(0)?,
            visitor_4_id: row.get(0)?,
            visitor_4_name: row.get(0)?,
            visitor_4_pos: row.get(0)?,
            visitor_5_id: row.get(0)?,
            visitor_5_name: row.get(0)?,
            visitor_5_pos: row.get(0)?,
            visitor_6_id: row.get(0)?,
            visitor_6_name: row.get(0)?,
            visitor_6_pos: row.get(0)?,
            visitor_7_id: row.get(0)?,
            visitor_7_name: row.get(0)?,
            visitor_7_pos: row.get(0)?,
            visitor_8_id: row.get(0)?,
            visitor_8_name: row.get(0)?,
            visitor_8_pos: row.get(0)?,
            visitor_9_id: row.get(0)?,
            visitor_9_name: row.get(0)?,
            visitor_9_pos: row.get(0)?,
            home_1_id: row.get(0)?,
            home_1_name: row.get(0)?,
            home_1_pos: row.get(0)?,
            home_2_id: row.get(0)?,
            home_2_name: row.get(0)?,
            home_2_pos: row.get(0)?,
            home_3_id: row.get(0)?,
            home_3_name: row.get(0)?,
            home_3_pos: row.get(0)?,
            home_4_id: row.get(0)?,
            home_4_name: row.get(0)?,
            home_4_pos: row.get(0)?,
            home_5_id: row.get(0)?,
            home_5_name: row.get(0)?,
            home_5_pos: row.get(0)?,
            home_6_id: row.get(0)?,
            home_6_name: row.get(0)?,
            home_6_pos: row.get(0)?,
            home_7_id: row.get(0)?,
            home_7_name: row.get(0)?,
            home_7_pos: row.get(0)?,
            home_8_id: row.get(0)?,
            home_8_name: row.get(0)?,
            home_8_pos: row.get(0)?,
            home_9_id: row.get(0)?,
            home_9_name: row.get(0)?,
            home_9_pos: row.get(0)?,
            additional_info: row.get(0)?,
            acquisition_info: row.get(0)?,
        })
    }
